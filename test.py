...
# Paste your own R_HOME var here
...
source_folder = r"/Users/mippr/Documents/OSPythonTest/Data"
range_min = 650
range_max = 4000

export_xlsx = "FILENAME.xlsx"
export_dir = r"/Users/mippr/Documents/OSPythonTest"


folder_path = r"/Users/mippr/Documents/OSPythonTest"
...
def process_csv_files(folder_path, range_min, range_max):
    ...
    # Save zip file location to environment
    os.environ['zipped_file_path'] = zipped_file_path
    return zipped_file_path

process_csv_files(folder_path, range_min, range_max)
...
def r_script(folder_path, range_min, range_max):
    ...
    # Retrieve zipped_file_path
    zipped_file_path = os.environ.get("zipped_file_path")
    ...
    ro.globalenv["zipped_file_path"] = zipped_file_path
    ...
    files <- read_any(zipped_file_path) |>
...
r_script(folder_path, range_min, range_max)
